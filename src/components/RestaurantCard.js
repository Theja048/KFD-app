	...
	return (
		<div className="m-3 p-3 w-[190px] rounded-lg bg-slate-100 hover:bg-gray-300">
			<div className="grid grid-flow-row">
				...
				<div className="ml-3">
					<h2 className="font-semibold text-lg text-black font-serif">
						{name}
					</h2>
					<div className="font-Bold flex gap-1 text-color-3">
						...
						<span className=" text-base text-black">{avgRating} • </span>
						{sla.slaString}
					</div>
					<p className="font-Thin text-gray-500 overflow-x-hidden overflow-y-hidden ">
						{cuisines.join(", ")}
					</p>
